...
class SplashViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        Alamofire.request(
            "\(Constants.rootDomain)/\(Constants.MyKey)/json/SearchPerformanceBySubjectService/1/9/18/", method: HTTPMethod.get, parameters: nil, headers: nil).responseJSON { (response) in
                print("///// response- 4123: \n", response)
